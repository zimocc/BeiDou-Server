...
import org.gms.soloMapling.ArtificialPlayer.TestMethods;
...
import static org.gms.soloMapling.ArtificialPlayer.BotCommandsPack.WarpCommands.botMoveMap;
import static org.gms.soloMapling.ArtificialPlayer.BotMovementSystem.MovementCommands.BotIdleStandingUpdate;
import static org.gms.soloMapling.ArtificialPlayer.BotMovementSystem.MovementCommands.botFallDownPacket;
import static org.gms.soloMapling.ArtificialPlayer.BotMovementSystem.MovementCommands.findFootHoldId;
import static org.gms.soloMapling.ArtificialPlayer.BotMovementSystem.MovementCommands.interruptBotMovement;
import static org.gms.soloMapling.ArtificialPlayer.BotMovementSystem.MovementCommands.testInterruptMovement;
import static org.gms.soloMapling.ArtificialPlayer.BotMovementSystem.MovementCommands.testInterruptPathfinder;
import static org.gms.soloMapling.ArtificialPlayer.BotMovementSystem.InPacketReader.setMoveDataRecording;
import static org.gms.soloMapling.ArtificialPlayer.BotMovementSystem.InPacketReader.setMovementDataRecordingMapId;
import static org.gms.soloMapling.ArtificialPlayer.TestMethods.botmovetest;
    ...
    public static void handleNumberedCommand(String input, int input2, Client c) {
        ...
        switch (input.toLowerCase()) {
            ...
            case "faceme":
                ...
                break;
            case "wander":
                org.gms.soloMapling.ArtificialPlayer.BotWanderSystem.BotWanderSystem.start(fakechar);
                player.yellowMessage("Bot " + fakechar.getId() + " wandering this map");
                break;
            case "wandernear":
                // loiter near your X (radius 150) - the "near an NPC/object" mode
                org.gms.soloMapling.ArtificialPlayer.BotWanderSystem.BotWanderSystem.start(fakechar, c.getPlayer().getPosition().x, 150);
                player.yellowMessage("Bot " + fakechar.getId() + " wandering near you (r=150)");
                break;
            case "wanderstop":
                org.gms.soloMapling.ArtificialPlayer.BotWanderSystem.BotWanderSystem.stop(fakechar);

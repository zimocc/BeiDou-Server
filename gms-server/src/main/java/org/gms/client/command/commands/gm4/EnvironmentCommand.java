...
import org.gms.soloMapling.ArtificialPlayer.BotGrindSystem.MapGrindProfile;
import org.gms.soloMapling.ArtificialPlayer.BotGrindSystem.Spot;
...
import org.gms.soloMapling.ArtificialPlayer.BotChatterSystem.TownChatterLines;
...
import org.gms.soloMapling.ArtificialPlayer.BotTownSystem.TownPinsStore;
...
import org.gms.soloMapling.server.BotPerfStats;
...
import static org.gms.soloMapling.Environment.PlatformPlacement.botMoveToPlatformAnyUnoccupiedSpot;
import static org.gms.soloMapling.Environment.EnvironmentManager.environmentLoadStartup;
import static org.gms.soloMapling.Environment.PlatformPlacement.getAllCharsOnPlatform;
import static org.gms.soloMapling.Environment.PlatformPlacement.getAvailablePlatformIds;
...
import static org.gms.soloMapling.Environment.EnvironmentManager.spawnBotsInFMEntrance;
import static org.gms.soloMapling.Environment.EnvironmentManager.spawnCasinoNpcs;
import static org.gms.soloMapling.Environment.PlatformPlacement.spawnFillerBots;
import static org.gms.soloMapling.Environment.EnvironmentManager.spawnScatteredTrainingBots;
import static org.gms.soloMapling.Environment.EnvironmentManager.spawnTownPresence;
import static org.gms.soloMapling.Environment.EnvironmentManager.spawnSocialCohort;
import static org.gms.soloMapling.Environment.EnvironmentManager.spawnTownWanderers;
import static org.gms.soloMapling.Environment.EnvironmentManager.spawnFillerBotsHenesys;
import static org.gms.soloMapling.Environment.EnvironmentManager.spawnFillerBotsHenesysMarket;
import static org.gms.soloMapling.Environment.EnvironmentManager.spawnFillerBotsHenesysPark;
import static org.gms.soloMapling.Environment.EnvironmentManager.spawnFillerBotsGameZone;
import static org.gms.soloMapling.Environment.PlatformPlacement.spawnFillerBotsLockedY;
import static org.gms.soloMapling.Environment.EnvironmentManager.spawnFillerBotsPotionShop;
import static org.gms.soloMapling.Environment.EnvironmentManager.convertRandomFillersToScrollBots;
import static org.gms.soloMapling.Environment.EnvironmentManager.spawnOPQBotsInLobby;
import static org.gms.soloMapling.Environment.EnvironmentManager.spawnGameZoneHostBots;
import static org.gms.soloMapling.Environment.EnvironmentManager.spawnAttackTestBots;
import static org.gms.soloMapling.Environment.EnvironmentManager.spawnBlackjackTables;
import static org.gms.soloMapling.Environment.EnvironmentManager.spawnGachaBotsHenesys;
import static org.gms.soloMapling.Environment.EnvironmentManager.spawnHenesysBots;
import static org.gms.soloMapling.Environment.EnvironmentManager.spawnMerchBotsInFMEntrance;
...
public class EnvironmentCommand extends Command {
    ...
    private static void dumpGrindProfile(Client c) {
        ...
        if (!p.stacks().isEmpty()) {
            int bestFeed = 0;
            int hop = 0;
            for (org.gms.soloMapling.ArtificialPlayer.BotGrindSystem.SpotStack st : p.stacks()) {
        ...
        player.yellowMessage(String.format("occupancy: %d bots targeting this map / capacity %d",
                org.gms.soloMapling.ArtificialPlayer.BotGrindSystem.TrainingMapChooser.botsTargeting(p.mapId()),
                org.gms.soloMapling.ArtificialPlayer.BotGrindSystem.TrainingMapChooser.mapCapacity(p.mapId())));
        if (p.spots().isEmpty()) {

...
import org.gms.soloMapling.ArtificialPlayer.BotAttackSystem.BotAttackData;
import org.gms.util.PacketCreator;

import java.util.Collections;
import java.util.Map;

import static org.gms.soloMapling.ArtificialPlayer.BotMovementSystem.MovementCommands.facingLeft;
...
public final class BotAttack {
    ...
    public static void basicSwing(Character chr) {
        ...
        chr.getMap().broadcastMessage(
                chr,
                PacketCreator.closeRangeAttackBot(
                        chr,
                        /* skill        */ 0,
                        /* skilllevel   */ 0,
                        /* stance       */ facingMask,
    ...
    public static void skillSwing(Character chr, int skillId) {
        ...
        chr.getMap().broadcastMessage(
                chr,
                PacketCreator.closeRangeAttackBot(chr, skillId, resolveSkillLevel(skillId), facingMask,
    ...
    public static void magicSwing(Character chr, int skillId) {
        ...
        chr.getMap().broadcastMessage(
                chr,
                PacketCreator.magicAttackBot(chr, skillId, resolveSkillLevel(skillId), facingMask,

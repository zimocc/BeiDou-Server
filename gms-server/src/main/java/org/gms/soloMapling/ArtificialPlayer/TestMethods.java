...
import org.gms.soloMapling.ArtificialPlayer.BotMovementSystem.MovementStructures.TimeCoordinatePair;
...
import static org.gms.soloMapling.ArtificialPlayer.BotCommandsPack.WarpCommands.botEnterFMRoom;
import static org.gms.soloMapling.ArtificialPlayer.BotCommandsPack.WarpCommands.botExitFMRoom;
import static org.gms.soloMapling.ArtificialPlayer.BotGeneration.getConsoleBot;
import static org.gms.soloMapling.ArtificialPlayer.BotMovementSystem.InPacketReader.getMovementRecording;
import static org.gms.soloMapling.ArtificialPlayer.BotMovementSystem.MovementCommands.BotMoveStreamHelper;
import static org.gms.soloMapling.ArtificialPlayer.BotMovementSystem.MovementCommands.BotMoveStreamOffset;
import static org.gms.soloMapling.ArtificialPlayer.BotMovementSystem.MovementCommands.BotMoveStreamUntilStopPoint;
//import static org.gms.soloMapling.ArtificialPlayer.BotMovementSystem.MovementCommands.injectIntoMovementStreamWithEndPoint;
//import static org.gms.soloMapling.ArtificialPlayer.BotMovementSystem.NavigationSystem.FMMovementCommands.MoveBetweenTwoDoorsSameRow;
//import static org.gms.soloMapling.ArtificialPlayer.BotMovementSystem.NavigationSystem.FMMovementCommands.moveBetweenFMRowsUp;
import static org.gms.soloMapling.ArtificialPlayer.BotMovementSystem.NavigationSystem.FMMovementCommands.moveToFMDoor;
//import static org.gms.soloMapling.ArtificialPlayer.BotMovementSystem.NavigationSystem.PathFinderbeta.pathFinderTest;
import static org.gms.soloMapling.ArtificialPlayer.BotMovementSystem.NavigationSystem.PathFinder.coordPathBuilder;
import static org.gms.soloMapling.ArtificialPlayer.BotMovementSystem.NavigationSystem.PathFinder.coordPathSplitter;
import static org.gms.soloMapling.DebugUtilities.debugprint;
import static org.gms.soloMapling.ArtificialPlayer.BotCommandsPack.MapleMessengerCommands.addBotToMessenger;
